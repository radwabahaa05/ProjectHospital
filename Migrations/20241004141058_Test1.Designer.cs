...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241004141058_Test1")]
    partial class Test1
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 5, 17, 10, 58, 222, DateTimeKind.Local).AddTicks(8208),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 6, 17, 10, 58, 222, DateTimeKind.Local).AddTicks(8257),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 4, 17, 10, 58, 222, DateTimeKind.Local).AddTicks(8273),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 19, 17, 10, 58, 222, DateTimeKind.Local).AddTicks(8276),
                            DoctorID = 2,
