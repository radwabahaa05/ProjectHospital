...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241001220549_mig23")]
    partial class mig23
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 3, 1, 5, 49, 380, DateTimeKind.Local).AddTicks(6212),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 4, 1, 5, 49, 380, DateTimeKind.Local).AddTicks(6274),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 2, 1, 5, 49, 380, DateTimeKind.Local).AddTicks(6295),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 17, 1, 5, 49, 380, DateTimeKind.Local).AddTicks(6299),
                            DoctorID = 2,
