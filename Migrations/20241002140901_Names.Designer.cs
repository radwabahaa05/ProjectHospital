...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241002140901_Names")]
    partial class Names
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 3, 17, 9, 1, 277, DateTimeKind.Local).AddTicks(9694),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 4, 17, 9, 1, 277, DateTimeKind.Local).AddTicks(9758),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 2, 17, 9, 1, 277, DateTimeKind.Local).AddTicks(9813),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 17, 17, 9, 1, 277, DateTimeKind.Local).AddTicks(9816),
                            DoctorID = 2,
