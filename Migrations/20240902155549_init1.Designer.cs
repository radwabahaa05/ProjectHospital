...
namespace DepiProject.Migrations
{
    ...
    [Migration("20240902155549_init1")]
    partial class init1
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 3, 18, 55, 47, 453, DateTimeKind.Local).AddTicks(4640),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 4, 18, 55, 47, 453, DateTimeKind.Local).AddTicks(4698),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 8, 3, 18, 55, 47, 453, DateTimeKind.Local).AddTicks(4727),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 8, 18, 18, 55, 47, 453, DateTimeKind.Local).AddTicks(4734),
                            DoctorID = 2,
