...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241007213954_roles")]
    partial class roles
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 9, 0, 39, 53, 398, DateTimeKind.Local).AddTicks(3600),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 10, 0, 39, 53, 398, DateTimeKind.Local).AddTicks(3934),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 8, 0, 39, 53, 398, DateTimeKind.Local).AddTicks(4098),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 23, 0, 39, 53, 398, DateTimeKind.Local).AddTicks(4103),
                            DoctorID = 2,
