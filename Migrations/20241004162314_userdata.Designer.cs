...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241004162314_userdata")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 5, 19, 23, 14, 287, DateTimeKind.Local).AddTicks(3148),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 6, 19, 23, 14, 287, DateTimeKind.Local).AddTicks(3203),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 4, 19, 23, 14, 287, DateTimeKind.Local).AddTicks(3221),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 19, 19, 23, 14, 287, DateTimeKind.Local).AddTicks(3224),
                            DoctorID = 2,
