...
namespace DepiProject.Migrations
{
    ...
    [Migration("20240901233513_mig123")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 3, 2, 35, 12, 987, DateTimeKind.Local).AddTicks(8791),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 4, 2, 35, 12, 987, DateTimeKind.Local).AddTicks(8851),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 8, 3, 2, 35, 12, 987, DateTimeKind.Local).AddTicks(8868),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 8, 18, 2, 35, 12, 987, DateTimeKind.Local).AddTicks(8873),
                            DoctorID = 2,
