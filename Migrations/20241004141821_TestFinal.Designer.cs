...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241004141821_TestFinal")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 5, 17, 18, 20, 745, DateTimeKind.Local).AddTicks(7437),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 6, 17, 18, 20, 745, DateTimeKind.Local).AddTicks(7483),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 4, 17, 18, 20, 745, DateTimeKind.Local).AddTicks(7503),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 19, 17, 18, 20, 745, DateTimeKind.Local).AddTicks(7506),
                            DoctorID = 2,
