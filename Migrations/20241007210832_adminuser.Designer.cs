...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241007210832_adminuser")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 9, 0, 8, 32, 527, DateTimeKind.Local).AddTicks(278),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 10, 0, 8, 32, 527, DateTimeKind.Local).AddTicks(323),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 8, 0, 8, 32, 527, DateTimeKind.Local).AddTicks(342),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 23, 0, 8, 32, 527, DateTimeKind.Local).AddTicks(345),
                            DoctorID = 2,
