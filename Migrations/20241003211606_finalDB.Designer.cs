...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241003211606_finalDB")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 5, 0, 16, 5, 851, DateTimeKind.Local).AddTicks(8385),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 6, 0, 16, 5, 851, DateTimeKind.Local).AddTicks(8428),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 4, 0, 16, 5, 851, DateTimeKind.Local).AddTicks(8445),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 19, 0, 16, 5, 851, DateTimeKind.Local).AddTicks(8448),
                            DoctorID = 2,
