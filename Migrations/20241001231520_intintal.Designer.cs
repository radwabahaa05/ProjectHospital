...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241001231520_intintal")]
    partial class intintal
    {
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 3, 2, 15, 20, 516, DateTimeKind.Local).AddTicks(9113),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 4, 2, 15, 20, 516, DateTimeKind.Local).AddTicks(9191),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 2, 2, 15, 20, 516, DateTimeKind.Local).AddTicks(9209),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 17, 2, 15, 20, 516, DateTimeKind.Local).AddTicks(9212),
                            DoctorID = 2,
