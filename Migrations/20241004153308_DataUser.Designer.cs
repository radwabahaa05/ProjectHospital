...
namespace DepiProject.Migrations
{
    ...
    [Migration("20241004153308_DataUser")]
            ...
            modelBuilder.Entity("DepiProject.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 10, 5, 18, 33, 7, 659, DateTimeKind.Local).AddTicks(4066),
                            DoctorID = 1,
                            NurseID = 1,
                            PatientID = 1,
                            Status = "Scheduled"
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 10, 6, 18, 33, 7, 659, DateTimeKind.Local).AddTicks(4109),
                            DoctorID = 2,
                            NurseID = 2,
                            PatientID = 2,
                            Status = "Scheduled"
            ...
            modelBuilder.Entity("DepiProject.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Date = new DateTime(2024, 9, 4, 18, 33, 7, 659, DateTimeKind.Local).AddTicks(4126),
                            DoctorID = 1,
                        ...
                        {
                            ID = 2,
                            Date = new DateTime(2024, 9, 19, 18, 33, 7, 659, DateTimeKind.Local).AddTicks(4129),
                            DoctorID = 2,
